...
const SearchSection = () => {
  ...
  return (
    <div className={`flex items-center justify-between p-4 shadow-md`} style={{backgroundColor:theme=='black'?'#1e293b':'#e2e8f0'}}>
      {/* Search Input */}
      ...
      {/* Notification Icon */}
      <div className="relative mr-4 text-slate-600">
