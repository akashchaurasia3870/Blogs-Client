...
function NewsLatter() {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center mb-4 md:mb-0 w-full md:w-[50%] ">
            ...
            <div className="flex items-center justify-center w-full md:w-[50%] ">
                <input type="email" placeholder="Enter your email" className="p-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-indigo-500"/>
