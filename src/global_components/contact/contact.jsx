        ...
        <div>
            ...
            >
                <div className="md:w-1/2 mb-6 md:mb-0 max-h-[50vh] relative mx-1">
                    ...
                    <img src="http://localhost:5000/data/images/2d5db27d-525c-4feb-88d0-0b353ddbc7f6.png" alt="Contact Us" className="rounded-md mb-4 w-full h-[360px] object-contain p-6"/>
